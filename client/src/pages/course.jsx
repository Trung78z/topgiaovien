...
export default function CourseTopTeacher() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        setCategoryCourse(allSubCategories);
        if (topic || location) {
  ...
  const title = ` Khóa học | Top Giáo Viên ${new Date().getFullYear()} - Đánh Giá & Danh
          Sách Tốt Nhất`;
  return (
    <>
      <Helmet>
      ...
      <div className="space-y-6 sm:space-y-20">
        <div className="relative bg-[#EAEBF1]">
          <div className="container flex flex-wrap items-center justify-evenly gap-x-2 px-2 pt-10 md:flex-nowrap">
            <div className="flex flex-col items-center space-y-6 sm:max-w-[550px] sm:items-start">
              <h1 className="flex flex-col items-center text-4xl font-semibold text-primary-500 sm:items-start sm:text-[48px]">
                Học kèm
                <span className="text-center text-[32px] sm:text-start">
                  Hiệu quả mà linh hoạt
                </span>
              </h1>
              <ul className="list-disc pl-0 sm:pl-10">
                <li className="text-primary-500">
                  Top giáo viên phát triển lớp kèm và các lớp học nhóm nhỏ
                </li>
                <li className="text-primary-500">
                ...
                <div className="relative h-[50%]">
                  <HoverCard>
                    <HoverCardTrigger>
                      <img
                        loading="lazy"
                        src="/assets/course/top giáo viên khóa học.jpg"
                        alt="Top giáo viên"
                        className="h-[200px] w-full rounded-lg object-cover sm:h-full"
                        width={1920}
                        height={1080}
                      />
                    </HoverCardTrigger>
                    <HoverCardContent
                      className="relative w-full max-w-screen-sm translate-y-1/4 bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
                ...
                <div className="h-[60%]">
                  <HoverCard>
                    <HoverCardTrigger>
                      <img
                        loading="lazy"
                        src="/assets/course/top giáo viên (4).jpg"
                        alt="Top giáo viên"
                        className="h-[200px] w-full rounded-lg object-cover sm:h-full"
                        width={1920}
                        height={1080}
                    ...
                    <HoverCardContent
                      className="relative w-full max-w-screen-sm translate-y-[15%] bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
                        src="/assets/course/top giáo viên (4).jpg"
                        alt="Top giáo viên"
                        className="h-[200px] w-full rounded-lg object-cover sm:h-full sm:max-h-[60vh]"
                        width={1920}
                        height={1080}
                      />
                    </HoverCardContent>
                ...
                <div className="h-[60%]">
                  <HoverCard>
                    <HoverCardTrigger>
                      <img
                        loading="lazy"
                        src="/assets/course/top giáo viên (3).jpg"
                        alt="Top giáo viên"
                        className="h-[200px] w-full rounded-lg object-cover sm:h-full"
                        width={1920}
                        height={1080}
                    ...
                    <HoverCardContent
                      className="relative w-full max-w-screen-sm translate-y-1/3 bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
                ...
                <div className="h-[40%]">
                  <HoverCard>
                    <HoverCardTrigger>
                      <img
                        loading="lazy"
                        src="/assets/course/top giáo viên (2).jpg"
                        alt="Top giáo viên"
                        className="h-[200px] w-full rounded-lg object-cover sm:h-full"
                        width={1920}
                        height={1080}
