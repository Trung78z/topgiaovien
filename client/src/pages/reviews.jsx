...
import ReviewVideo from "@/components/video-review";
import {
  getImageReview,
  getReviewVideo,
  getReviewZingNew,
...
function getRandomImagesByRandomTeacher(data, count) {
  ...
  const filteredImages = data.filter(
    (item) => item.teacherId === randomTeacherId,
  );
...
export default function Reviews() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        const resNew = await getReviewZingNew();
        const resImage = await getImageReview();
        ...
        if (data.length >= 8) {
          ...
          setFirstPart(data.slice(0, midpoint));
          setSecondPart(data.slice(midpoint));
          setDataReviewVideo(data);
        } else {
          setDataReviewVideo(data);
        }
      } catch (error) {
  ...
  const title = ` Review | Top Giáo Viên ${new Date().getFullYear()} - Đánh Giá & Danh
          Sách Tốt Nhất`;
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Khám phá các khóa học hàng đầu từ giáo viên xuất sắc tại Việt Nam. Tìm khóa học phù hợp nhất với đánh giá chi tiết và thông tin liên hệ tại TopGiaoVien.vn."
        />
      </Helmet>
      ...
      <div className="space-y-6 sm:space-y-20">
        <div className="relative bg-[#EAEBF1]">
          <div className="container flex flex-wrap items-center justify-evenly gap-x-2 px-2 pt-10 md:flex-nowrap">
            <div className="flex flex-col items-center space-y-6 sm:max-w-[600px] sm:items-start">
              <h1 className="flex flex-col items-center text-4xl font-semibold text-primary-500 sm:items-start sm:text-[48px]">
                Excellence Starts With Topgiaovien
              </h1>
              <ul className="list-disc pl-0 sm:pl-2">
              ...
              <div className="flex items-center gap-x-10">
                ...
                <Link to="http://elearning.topgiaovien.vn" target="_blank">
                  <Button
                    variant="outline"
                    className="hover:bg-gray-1920 border border-primary-500 text-primary-500"
                  >
                    Test trình độ
                  </Button>
                </Link>
            ...
            <div className="grid w-full grid-cols-1 gap-2 pt-6 sm:max-w-96 sm:grid-cols-2 sm:pt-0">
              <div className="relative col-span-1 flex flex-col items-center gap-2">
                <div className="relative h-[50%]">
                  <HoverCard>
                    ...
                    <HoverCardContent
                      className="relative h-auto w-full max-w-screen-sm translate-y-1/4 bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
                ...
                <div className="h-[60%]">
                  <HoverCard>
                    ...
                    <HoverCardContent
                      className="relative h-auto w-full max-w-screen-sm translate-y-[15%] bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
              ...
              <div className="col-span-1 hidden flex-col items-center gap-2 sm:flex">
                <div className="h-[60%]">
                  <HoverCard>
                    ...
                    <HoverCardContent
                      className="relative h-auto w-full max-w-screen-sm translate-y-1/3 bg-background"
                      side="left"
                    >
                      <img
                        loading="lazy"
          ...
          <div className="container relative mx-auto flex flex-wrap items-center justify-around gap-x-2 gap-y-4 rounded-[14px] bg-neutral p-4 shadow-lg sm:translate-y-1/2 sm:flex-nowrap sm:gap-x-10 md:p-4">
        ...
        <div className="relative bg-[#EAEBF1]">
          <div className="container space-y-6 px-2 sm:p-10">
            ...
            {dataReviewVideo?.length >= 10 ? (
              <>
                <ReviewVideo data={firstPart} />
                <ReviewVideo data={secondPart} />
              </>
            ) : (
        ...
        {dataReviewNew.length > 0 && (
          <div className="relative bg-[#EAEBF1]">
            <div className="container space-y-6 px-2 sm:p-10">
              <h2 className="text-3xl font-semibold text-primary-500">
                Báo chí và truyền thông nói gì về Top giáo viên?
              </h2>
              {dataReviewNew.slice(0, show).map((item) => (
                <div key={item.id}>
                  <CardZingNew props={item} />
                </div>
              ))}
              {dataReviewNew.length > 0 ? (
        ...
        <ReviewShareCourse />
        <ImageMoment image={dataImageMoment} />
        <div ref={targetRef}>
          <NhanTuVanPage
