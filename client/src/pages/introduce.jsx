...
export default function Introduce() {
  ...
  return (
    <>
      <Helmet>
        <title>
          {`Giới thiệu | Top Giáo Viên ${new Date().getFullYear()} - Đánh Giá &
          Danh Sách Tốt Nhất`}
        </title>
        <meta
          name="description"
          content={`Khám phá những giáo viên xuất sắc nhất Việt Nam. Tìm kiếm giáo viên tốt nhất ${new Date().getFullYear()} với đánh giá chi tiết và thông tin liên hệ tại TopGiaoVien.vn.`}
        />
      </Helmet>
      <h1 className="hidden">Giới thiệu về top giáo viên</h1>
      <div className="space-y-6 sm:space-y-10">
        ...
        <div className="container mx-auto px-0 pt-5">
          <div className="grid grid-cols-1 px-0 sm:grid-cols-5 sm:gap-10">
            <div className="col-span-1 sm:col-span-2">
              <div className="relative">
                <div className="card-hover relative z-20 flex -translate-y-2 items-center justify-center sm:translate-y-0">
                  <img
                    loading="lazy"
            ...
            <div className="col-span-1 flex w-full items-center justify-center pt-10 sm:col-span-3 sm:pt-0">
              <div className="rounded-lg bg-primary-50 p-2 sm:h-max sm:w-max sm:p-10">
                ...
                <div className="relative flex items-center justify-between p-8 sm:p-10">
                  ...
                  <p>
                    Vai trò của giáo viên không phải là chia sẻ kiến thức mà
