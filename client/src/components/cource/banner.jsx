...
// export default function BannerCourse({ scrollToTarget }) {
//   return (
...
//           </div>
//         </div>
//         <div className="grid w-full grid-cols-1 gap-2 pt-6 sm:max-w-screen-sm sm:grid-cols-2 sm:gap-4 sm:pt-0">
