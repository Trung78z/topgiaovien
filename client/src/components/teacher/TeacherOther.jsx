...
import { voteLevel } from "@/lib/data";
...
const priceCourse = [
  { type: "Thấp đến cao", value: "asc" },
  { type: "Cao đến thấp", value: "dsc" },
];
export default function TeacherOther({ categoryCourseParent, dataParent }) {
      ...
      {dataActive && data.length > 0 ? (
        ...
        >
          ...
          <div className="mt-8 flex w-full flex-col lg:w-2/3">
            <div className="relative grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4">
              <button
