...
export default function BannerELearning({ props, scrollToTarget }) {
  return (
    <div className="relative bg-[#EAEBF1]">
      <div className="container flex flex-wrap items-center justify-evenly gap-2 px-2 pt-10 md:flex-nowrap">
        <div className="flex w-full flex-col items-center space-y-6 sm:items-start md:w-[750px]">
          <h1 className="flex flex-col items-center font-semibold text-primary-500 sm:items-start sm:text-[40px]">
            Khóa học
            <span className="text-center text-3xl sm:text-start sm:text-[52px]">
              {props?.title}
            </span>
          </h1>
          <ul className="list-inside list-disc px-2 sm:pl-10">
            {props?.content
              ?.trim()
              .split("\n")
              .map((line, index) => (
        ...
        <img
          ...
          width={442}
          height={519}
          className="border-3 rounded-2xl border-primary-500"
          alt="error"
        />
      </div>
      <div className="container relative mx-auto mt-10 flex flex-wrap items-center justify-around gap-x-2 gap-y-4 rounded-[14px] bg-neutral p-4 px-2 shadow-lg sm:translate-y-1/2 sm:flex-nowrap sm:gap-x-10 md:p-4">
