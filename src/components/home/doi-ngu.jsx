...
export default function DoiNguTop() {
  ...
  return (
    <div className="relative bg-[#EAEBF1] md:pb-80 lg:pb-60">
      <div className="container flex flex-wrap items-center justify-between gap-x-2 md:flex-nowrap">
      ...
      <div className="container relative bottom-0 left-1/2 mx-auto mt-10 grid -translate-x-1/2 grid-cols-1 gap-x-10 rounded-[14px] bg-neutral p-4 shadow-lg sm:absolute sm:translate-y-1/2 sm:grid-cols-2 md:grid-cols-3 md:p-10">
        ...
        <div className="col-span-1 space-y-5 p-2">
          <img
            src={icon2}
