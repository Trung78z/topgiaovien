...
export default function GiaoVienTinhHoa({ props }) {
  const [dataActive, setDataActive] = useState(data_giao_vien_tinh_hoa[0]);
  const [data, setData] = useState(data_giao_vien_tinh_hoa);
  ...
  return (
    <div className="container mx-auto px-0">
      ...
      <div className="flex flex-wrap gap-x-10 rounded-lg bg-white px-2 md:px-0 lg:flex-nowrap">
        <div className="flex w-full flex-col pt-4 lg:w-1/3">
          <div className="flex w-full items-center justify-center py-4">
            <img
              src={dataActive.photoUrl}
              alt="Teacher"
              className="h-80 w-full items-center rounded-lg object-contain"
            />
          </div>
          <div className="w-full py-4">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li className="flex items-center">
                ...
                {dataActive.achievements[4]}
              </li>
            </ul>
            <div className="mt-4">
              <Link
                to={`/giao-vien/giao-vien-${convertToSlug(dataActive.name)}`}
        ...
        <div className="mt-8 flex w-full flex-col justify-between sm:min-h-[64vh] lg:min-h-[90vh] lg:w-2/3">
...
GiaoVienTinhHoa.prototype = {
  giaoVien: PropTypes.string,
};
