      ...
      <div className="space-y-6">
        <div className="container mx-auto space-y-6 px-2">
          ...
          <iframe
            ...
            src="https://www.youtube.com/embed/RLo3Cp-786M"
            title="YouTube video"
            frameBorder="0"
        ...
        <div className="container px-2">
          <div className="grid grid-cols-1 gap-y-3 sm:grid-cols-2 sm:gap-3 md:grid-cols-3 md:gap-x-10">
            <div className="col-span-1 space-y-3">
              ...
              <Link to="zoom.us/vi/download">zoom.us/vi/download</Link>
            </div>
            <div className="col-span-1 space-y-3">
              <img
                src="/assets/introduce/zoomOnline.png"
            ...
            <div className="col-span-1 space-y-3">
              ...
              <p>213/27 Nguyễn Gia Trí, Phường 25, quận Bình Thạnh</p>
              <Button variant="outline" className="flex items-center gap-x-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
        ...
        <div className="bg-primary-50 p-4 sm:p-20">
          <div className="space-y-4 p-4 sm:p-20">
          ...
          <div className="container w-full rounded-sm bg-background sm:p-20">
            {" "}
