...
export default function LoiHuaGiaoVien() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 gap-x-6 sm:grid-cols-2">
          <div className="space-y-8 rounded-br-[40px] rounded-tl-[40px] bg-primary-50 p-4 sm:p-10">
            ...
            <ul className="list-disc space-y-2 px-2">
              <li className="text-[16px] font-medium text-primary-500">
                Luôn nhiệt tình trong giảng dạy đảm bảo chất lượng và nội dung
                cho học viên như đã cung cấp ban đầu.
              </li>
              <li className="text-[16px] font-medium text-primary-500">
              ...
              <li className="text-[16px] font-medium text-primary-500">
                Không vắng lịch dạy mà không có lý do chính đáng.
              </li>
            </ul>
          </div>
