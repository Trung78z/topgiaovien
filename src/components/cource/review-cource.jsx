...
function Card({ data }) {
  return (
    <div className="space-y-2 rounded-lg border-2 bg-background pb-2 shadow-xl hover:shadow-2xl">
      ...
      <div className="flex items-center gap-x-2 px-3">
        <div className="space-y-1">
          <h4 className="text-[20px] font-medium">{data.username}</h4>
        </div>
      </div>
      <p className="px-3 text-justify text-sm">{data.content}</p>
