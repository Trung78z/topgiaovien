      ...
      <div className="space-y-6 sm:space-y-20">
        <div className="flex w-full flex-col items-center gap-4 bg-primary-50 p-4 sm:gap-8 sm:p-20">
          ...
          <p className="max-w-screen-md text-justify">
            Được thành lập từ năm 2013, IELTS TopGiaoVien hân hạnh là đơn vị uy
            tín tại Hồ Chí Minh, đồng hành cùng Quý phụ huynh, Quý học viên và
            các đối tác trong lĩnh vực chuyên đào tạo Tiếng Anh học thuật
            (Academic), Tổng quát (General), tiếng Anh giao tiếp theo mô hình
            nhóm nhỏ, đáp ứng đầy đủ cho nhu cầu du học – làm việc và định cư
            nước ngoài của học viên.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 px-0 sm:grid-cols-5 sm:gap-10">
            <div className="col-span-1 sm:col-span-2">
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-1/2 z-10 -translate-x-[48%] fill-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-[400px] w-[400px]"
                    viewBox="0 0 400 424"
            ...
            <div className="col-span-1 flex w-full items-center justify-center p-0 sm:col-span-3">
              <div className="rounded-lg bg-primary-50 p-2 sm:h-max sm:w-max sm:p-10">
                ...
                <div className="relative flex items-center justify-between p-4 sm:p-10">
