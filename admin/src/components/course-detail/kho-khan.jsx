export default function KhoKhan({ props, handleChange }) {
  return (
    <>
      {" "}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 md:gap-6">
          <div className="col-span-1 space-y-3 rounded-lg border bg-background p-2 shadow-2xl sm:p-4">
            ...
            <h2 className="text-[20px] font-semibold">
              <textarea
                type="text"
                id="differentTitle1"
                value={props?.differentTitle1}
                onChange={handleChange}
                className="h-max w-full text-wrap rounded-lg border-2 p-1"
              />
            </h2>
            <p>
              <textarea
                type="text"
                id="differentContent1"
                value={props?.differentContent1}
                onChange={handleChange}
                className="content-scroll min-h-28 w-full text-wrap rounded-lg border-2 p-1"
              />
            </p>
          </div>
          <div className="col-span-1 space-y-3 rounded-lg border bg-background p-2 shadow-2xl sm:p-4">
            ...
            <p>
              <textarea
                type="text"
                id="differentContent2"
                value={props?.differentContent2}
                onChange={handleChange}
                className="content-scroll min-h-28 w-full text-wrap rounded-lg border-2 p-1"
              />
            </p>
          ...
          <div className="col-span-1 space-y-3 rounded-lg border bg-background p-2 shadow-2xl sm:p-4">
            ...
            <p>
              <textarea
                type="text"
                id="differentContent3"
                value={props?.differentContent3}
                onChange={handleChange}
                className="content-scroll min-h-28 w-full text-wrap rounded-lg border-2 p-1"
              />
            </p>
