...
import {
  editReviewZingNew,
  getReviewZingNewById,
} from "@/services/review-news";
...
export default function EditReviewNew() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        const res = await getReviewZingNewById(slug);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await editReviewZingNew(slug, formData);
      Swal.fire({
        icon: "success",
