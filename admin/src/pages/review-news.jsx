...
import { deleteReviewZingNew, getReviewZingNew } from "@/services/review-news";
...
export default function ReviewNews() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        const res = await getReviewZingNew();
        setData(res.msg);
      } catch (error) {
        console.log(error);
      }
  ...
  const handleEdit = async (slug) => {
    navigate(`/reviews/news/chinh-sua/${slug}`);
  };
