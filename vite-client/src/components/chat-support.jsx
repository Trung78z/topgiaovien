...
function ChatSupport() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-4 p-4">
          ...
          <a
            ...
            className="flex items-center space-x-4 rounded-md bg-neutral-F5F5F5 p-2 ring-1 hover:bg-slate-200 focus:bg-slate-300"
          >
            <img src="/zalo.png" alt="Zalo Icon" className="h-8 w-8" />
            <div>
      ...
      <button
        className="fixed bottom-4 right-4 flex h-12 w-12 items-center justify-center rounded-full bg-indigo-900 text-white hover:bg-indigo-700"
        onClick={toggleVisibility}
      >
        {!isVisible ? (
          <svg
